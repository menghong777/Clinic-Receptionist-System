...
<html lang="en">
	<head>
		...
		<!-- Website title -->
		<title>Print report | Over Surgery</title>
...
<!--			    </div>
		...
		<div class="page-header"><h2>Emergency contact information</h2></div>
			...
			<table class="table table-hover table-condensed">
				...
				<tbody>
					<tr>
						<td><a class="btn btn-primary btn-sm" href="patient_print.html" role="button"><span class="glyphicon glyphicon-print"></span>&nbsp;&nbsp;Print</a>
						<a class="btn btn-default btn-sm" href="patient_print.html" role="button"><span class="glyphicon glyphicon-eye-open"></span>&nbsp;&nbsp;Preview</a></td>
						<td>Xray</td>
						<td>01/11/2014</td>
						<td>01/11/2014</td>
					</tr>
					<tr>
						<td><a class="btn btn-primary btn-sm" href="patient_prescription.html" role="button"><span class="glyphicon glyphicon-print"></span>&nbsp;&nbsp;Print</a>
						<a class="btn btn-default btn-sm" href="patient_print.html" role="button"><span class="glyphicon glyphicon-eye-open"></span>&nbsp;&nbsp;Preview</a></td>
